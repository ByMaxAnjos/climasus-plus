...
| Sistema | Download |
|---|---|
| **macOS** (Apple Silicon) | [climasus+.Studio_1.0.6_aarch64.dmg](https://github.com/ByMaxAnjos/climasus-plus/releases/download/v1.0.6/climasus%2B.Studio_1.0.6_aarch64.dmg) |
| **Windows** (x64) | [climasus+.Studio_1.0.6_x64-setup.exe](https://github.com/ByMaxAnjos/climasus-plus/releases/download/v1.0.6/climasus%2B.Studio_1.0.6_x64-setup.exe) |
| **Linux** (x64, deb) | [climasus+.Studio_1.0.6_amd64.deb](https://github.com/ByMaxAnjos/climasus-plus/releases/download/v1.0.6/climasus%2B.Studio_1.0.6_amd64.deb) |
| **Linux** (x64, AppImage) | [climasus+.Studio_1.0.6_amd64.AppImage](https://github.com/ByMaxAnjos/climasus-plus/releases/download/v1.0.6/climasus%2B.Studio_1.0.6_amd64.AppImage) |
...
> Anjos, M. (2026). *climasus+ Studio* (v1.0.6) [Software]. GitHub. https://github.com/ByMaxAnjos/climasus-plus
